...
class CallReceiverView extends StatefulWidget {
  ...
  @override
  State<CallReceiverView> createState() => _CallReceiverViewState();
}

class _CallReceiverViewState extends State<CallReceiverView> {
            ...
            child: Column(
              children: [
               ...
               SizedBox(
                ...
                Text("Bạn có một cuộc gọi ${call.isVideo ? "video" : "âm thanh"} từ ${call.remoteName}", 
    ...
    return Row(
      ...
      children: [
          _iconBtn(
            ...
            () {
              prov.acceptCall();
              // Sau khi bắt máy, sẽ tự động chuyển sang CallView (nơi hiển thị cuộc gọi thực sự)
              context.go('/call');
            }, 
            false, 
