...
//           ),
//           titleSpacing: 8,
//           title: const Text("Lời mời kết bạn", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w500)),
//           centerTitle: false,
//           actions: [
...
//           TextSpan(
//             text: '${provider.pendingReceived.length}',
//             style: const TextStyle(
...
//         ),
//         children: [
//           const TextSpan(text: 'Đã gửi '),
//           TextSpan(
//             text: '${provider.pendingSent.length}',
//             style: const TextStyle(
//               color: Color(0xFF0091FF),
//               fontWeight: FontWeight.bold,
//             ),
